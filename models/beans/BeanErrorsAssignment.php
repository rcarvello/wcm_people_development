...
class BeanErrorsAssignment extends MySqlRecord implements Bean
{
     ...
     */
    private $ddl = "";

    /**
     * setIdAssignment Sets the class attribute idAssignment with a given value
     *
     * The attribute idAssignment maps the field id_assignment defined as int(11).<br>
     * Comment for field id_assignment: Not specified.<br>
     ...
     *
     * The attribute assignedBy maps the field assigned_by defined as int(11).<br>
     * Comment for field assigned_by: Not specified.<br>
     ...
     *
     * The attribute assignmentDate maps the field assignment_date defined as varchar(45).<br>
     * Comment for field assignment_date: Not specified.<br>
    ...
    */
    ...
    public function select($idAssignment)
    {
        ...
        if ($result){
            ...
            @$this->assignmentDate = $this->replaceAposBackSlash($rowObject->assignment_date);
    ...
    public function insert()
    {
        ...
        $sql = <<< SQL
			...
			{$this->parseValue($this->assignmentDate,'notNumber')},
    ...
    public function update($idAssignment)
    {
        ...
        if ($this->allowUpdate) {
            ...
            SET 
				...
				assignment_date={$this->parseValue($this->assignmentDate,'notNumber')},
